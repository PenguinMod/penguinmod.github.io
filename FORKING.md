This file contains instructions on what you should do upon forking Permafy.
...
# Branding changes
Update any labels or text that says "Permafy" and put your mod's name.
...
Don't remove any credit to Scratch, TurboWarp, PenguinMod, or Permafy. That's just not cool.  
...
# Server changes
Unless you plan on keeping your mod 100% compatible with Permafy, please remove the Upload button and any project sharing features.

Our APIs are only built for Permafy and therefore will likely end up breaking in your mod at some point or another.

We also do not allow projects that only work outside of Permafy so if we end up having a lot of broken uploads from your site, then we'll have to block your site from being able to use the project API.
